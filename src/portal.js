    ...
    prtl_ruins: {
        ...
        inferno_power: {
            ...
            effect(wiki){
                ...
                return `<div>${loc('space_dwarf_reactor_effect1',[$(this)[0].power_gen(wiki)])}</div><div class="has-text-caution">${loc('portal_inferno_power_effect',[fuel.Infernite(),global.resource.Infernite.name,fuel.Coal(),global.resource.Coal.name,fuel.Oil(),global.resource.Oil.name])}</div>`;
            },
            action(){
                if (payCosts($(this)[0])){
